...
<img src="https://github.com/user-attachments/assets/4e852bcf-9886-4dcf-b397-aef5f6212c0f" alt="App Demo GIF" width="600" />
...
Demo Video:
<img src="https://github.com/user-attachments/assets/b38f8a42-2b2a-40e1-86ba-6be766dfd7b6" alt="App Demo GIF" width="600" />
...
[o] Implemented dt variable instead of constant like 0.016s (1/60, 60fps) so we can determine actual time passed as # each loop wont be perfectly same amount of time of 0.016s

[o] Organized control code into main()

[o] Added collsion with walls constant "B" representing Bounce factor

[o] Added optional high density mass, can be configured by user thru terminal. User can configure the density, and whether or not it is stationary. (if it is affected by surrounding ball's gravity or not)
